...
namespace Client_RemoteController_progetto
{
    public partial class Form5 : Form
    {
        ...
        private void comboBox1_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            else if (comboBox1.SelectedItem.Equals("SALOTTO"))
            {
                this.Hide();
                Form2 f2 = new Form2();
                f2.ShowDialog();
        ...
        private void rjToggleButton1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                this.inviaSegnale("CAPPA_ON");
            }
            else
            {
                this.inviaSegnale("CAPPA_OFF");
            }
        }
        ...
        private void rjToggleButton2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                this.inviaSegnale("FRIGO_ON");
            }
            else
            {
                this.inviaSegnale("FRIGO_OFF");
            }
        }
        ...
        private void rjToggleButton3_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                this.inviaSegnale("FORNO_ON");
            }
            else
            {
                this.inviaSegnale("FORNO_OFF");
            }
        }
    }
}
